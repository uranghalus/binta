...
interface Props {
    ...
    data: PaginatedData<AparInspection>;
    filters: {
        search?: string;
    };
}
export default function InspectionAparTable({ columns, data: paginatedData, filters }: Props) {
    ...
    return (
        <div className="space-y-4">
            <InspectionAparToolbar search={searchVal} onSearchChange={setSearchVal} />
