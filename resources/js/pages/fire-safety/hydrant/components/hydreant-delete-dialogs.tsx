...
export default function HydrantDeleteDialog({ open, onOpenChange, currentRow }: Props) {
    ...
    const handleDelete = () => {
        ...
        destroy(route('hydrant.destroy', currentRow.id), {
            preserveScroll: true,
            onSuccess: () => {
        ...
        <ConfirmDialog
            ...
            desc={
                <span className="text-gray-500">
                    Apakah Anda yakin ingin menghapus Hydrant <span className="font-bold">{currentRow.kode_unik}</span>?
                </span>
            }
        ...
        >
            ...
            <div className="mt-4 space-y-2">
                ...
                <Input
                    ...
                    placeholder={`Ketik "${currentRow.kode_unik}" untuk mengkonfirmasi penghapusan`}
                    disabled={processing}
                />
